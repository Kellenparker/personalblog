	...
	return (
		<header className='bg-white border-b border-gray-300 py-3'>
			<div className='container max-w-screen-md mx-auto flex items-stretch justify-between'>
				...
				<div className="flex py-0 ml-2 justify-center relative before:content-[''] before:block before:bg-primary before:w-1 before:h-full before:absolute before:left-[-20px] flex-col">
				...
				<div className="flex py-0 mr-2 items-center justify-between sm:justify-center relative after:content-[''] after:block after:bg-primary after:w-1 after:h-full after:absolute after:right-[-20px]">
					<nav className='flex flex-col sm:flex-row space-x-0 sm:space-x-4 items-end'>
						...
						<span className='hidden sm:block mx-2 flex items-center select-none'>·</span>{" "}
