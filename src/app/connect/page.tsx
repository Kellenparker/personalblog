	...
	return (
		<main className='container mx-auto max-w-screen-md divide-y'>
			<div className='container pattern-head p-2 my-10 max-w-sm'>
				<div className='flex flex-col justify-start w-fit p-2 h-full bg-white dark:bg-dark'>
					<h1 className='dark:text-white mb-5 font-bold text-4xl'>Connect with me!</h1>
